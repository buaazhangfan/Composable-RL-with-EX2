...
class QLearner(object):
  def __init__(
    ...
    self.replay_buffer = ReplayBuffer(replay_buffer_size, frame_history_len, lander=lander, vizdoom=vizdoom)
  ...
  def update_model(self):
    ...
    if (self.t > self.learning_starts and \
      ...
      # print(np.shape(obs_t_batch))
      # print(np.shape(act_batch))
      # print(np.shape(obs_tp1_batch))
      # exit()
